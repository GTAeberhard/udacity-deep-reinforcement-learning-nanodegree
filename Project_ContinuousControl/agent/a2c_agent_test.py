...
class DiscountedRewardsTest(unittest.TestCase):
    def test_simple_case(self):
        ...
        discounted_rewards = A2CAgent._calculate_discounted_rewards(rewards, gamma=1)
    ...
    def test_with_discount(self):
        ...
        discounted_rewards = A2CAgent._calculate_discounted_rewards(rewards, gamma=0.5)
    ...
    def test_with_discount_and_final_value(self):
        ...
        discounted_rewards = A2CAgent._calculate_discounted_rewards(rewards, final_values=[8], gamma=0.5)
